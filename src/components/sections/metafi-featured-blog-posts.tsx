...
export default function MetafiFeaturedBlogPosts({
  ...
  return (
    <section id="decision-tools" className="px-6 py-16 lg:py-24">
  ...
  return (
    <Link href={`/blog/${p.slug}`} className="block">
      <article className="grid grid-cols-1 items-stretch gap-4 sm:grid-cols-[250px_minmax(0,1fr)] sm:gap-6">
        <div
          className="relative aspect-[4/3] w-full overflow-hidden rounded-2xl sm:aspect-auto sm:h-full sm:w-[250px]"
